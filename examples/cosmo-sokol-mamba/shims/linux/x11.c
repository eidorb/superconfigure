...
static void load_X11_procs(void) {
    libX11 = deps_dlopen("libX11.so", RTLD_NOW | RTLD_GLOBAL);
...
static void load_Xcursor_procs(void) {
    libXcursor = deps_dlopen("libXcursor.so", RTLD_NOW | RTLD_GLOBAL);
...
static void load_Xi_procs(void) {
    libXi = deps_dlopen("libXi.so", RTLD_NOW | RTLD_GLOBAL);
